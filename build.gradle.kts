...
dependencies {
	...
	// Prometheus registry so actuator collects + exposes http.server.requests (p95/p99), HikariCP
	// pool saturation and JVM/GC metrics at /actuator/prometheus (auth-gated).
